  ...
  function reinstall_update_remove_vdsetup()
     {
         function menu()
         {
           ...
           # green_tick_en ;
            ...
            echo -en " $(green_1        ) $(green_n2)) " ; ttb=$(echo -e "Включить/отключить автоматическую синхронизацию. # (todo..) " ; ) && lang="nix" && bpn_p_lang ;
         ...
         function auto_sync_2()
         {
            # auto sync
            echo -en "\n $(black_U23A7) $(green_star)  " ; ttb=$(echo -e "Вы выбрали:") && lang="nix" && bpn_p_lang ;
            echo -en " $(black_U23A9) $(green_tick)  $(green_n2)) " ; ttb=$(echo -e "Включить/отключить автоматическую синхронизацию. (todo)\n") && lang="nix" && bpn_p_lang ;
         }
